...
export default class StatisticsCommand extends AbstractCommand implements Discord.ChatInputApplicationCommandData {
    ...
    public async execute(interaction: Discord.CommandInteraction): Promise<CommandExecutionResultConfig> {
        ...
        if(!member) member = interaction.member as Discord.GuildMember;
